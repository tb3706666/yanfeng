...
export default {
  appId: "yfjs",
  domain:"http://10.97.152.28",
  oaUrl: "http://10.97.152.28:7001/oa-node/",
  hrUrl: "http://10.97.152.28:7001/oa-node/",
  hrNewUrl: "http://10.97.152.28:7001/oa-node/",
  ...
  openAttach(url, fileName) {
    console.log(url);
    if(!window.appnest){
      url = this.oaUrl+'interface'+url.replace(this.oaUrl,'');
