...
module.exports = {
    async tongyonglist(ctx){
        ...
        let url_param = "method=list&nodeType=TEMPLATE&q.fdTemplate=14273a3894452d5de3bfbf34609a3f89&q.mydoc=approval";
        if(pageNum!=""){
    ...
    async tongyongquery(ctx){
        ...
        let url_param = "method=list&nodeType=TEMPLATE&q.fdTemplate=14273a3894452d5de3bfbf34609a3f89";
        if(param_subject!=''){
    ...
    async tongyongdetail(ctx){
        ...
        rspObj.sqr = $('form div table tbody').find('tr').eq(0).find('td').eq(1).find('div').eq(0).text().trim();
        rspObj.sqrbm = $('form div table tbody').find('tr').eq(1).find('td').eq(1).find('div').eq(0).text().trim();
        rspObj.mails = $('form div table tbody').find('tr').eq(1).find('td').eq(3).find('div').eq(0).text().trim();
        rspObj.ccjssj = $('form div table tbody').find('tr').eq(2).find('td').eq(1).text().trim();
        rspObj.jine = $('form div table tbody').find('tr').eq(2).find('td').eq(3).find('div').eq(0).text().trim();
        rspObj.beizhu = $('form div table tbody').find('tr').eq(5).find('td').eq(1).find('div').eq(0).text().trim();
        rspObj.caigoudanhao = $('form div table tbody').find('tr').eq(3).find('td').eq(1).find('div').eq(0).text().trim();
        rspObj.caigoudantitle = $('form div table tbody').find('tr').eq(3).find('td').eq(0).find('div').eq(0).text().trim();
