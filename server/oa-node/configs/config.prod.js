...
const database = {
    ...
    oracle: {
        ...
        password      : "i1736e",
        connectString : "10.178.149.71/WORKFLOW",
        events        :  true
    }
};

module.exports = {
    projectPath: '/oa-node', // 项目访问路径，一旦配置，所有的路由访问前必须加上此项目路径
    port: 7010,                                      //启动端口
    ...
    systemPath: { // 第三方接口地址配置
        oa: 'http://10.178.185.127:8080',
        hr: 'https://ae-nhrbs.adient.com/YFAS_NEWAD',
        hrnew: 'http://10.118.8.20',
    }
};